...
const string strMessageMagic = "NikephorosCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1200; // NikephorosCoin: 20 minutes
static const int64 nTargetSpacing = 600; // NikephorosCoin: 10 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal nikephoroscoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NikephorosCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcbe9e038e3f756e84b75143069763f738166d0b733d47e7c8c0072318f98f293");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Tue, 12 Aug 2014 00:01:21 GMT";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1407801681; //epochtime GMT: Tue, 12 Aug 2014 00:01:21 GMT
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1407801681;
            block.nNonce   = 113752;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3c8e2eb5497c44a9162b23d00bf842b0315bb087b161a9a267cd189f89bf396f"));
